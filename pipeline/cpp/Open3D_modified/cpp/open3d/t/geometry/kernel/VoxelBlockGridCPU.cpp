...
template void ExtractSemanticPointCloudCPU<float, uint16_t, uint16_t, uint8_t>(FN_ARGUMENTS);
template void ExtractSemanticPointCloudCPU<float, float, float, uint8_t>(FN_ARGUMENTS);
