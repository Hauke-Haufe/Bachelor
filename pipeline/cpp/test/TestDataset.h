...
class Tum_dataset{
    ...
    std::unordered_map<SubDataset, std::string> dataset_paths = {
        {SubDataset::static_xyz,        "/home/hauke/code/Beachlor/data/test_dataset/rgbd_dataset_freiburg1_xyz"},
        {SubDataset::walking_xyz,       "/home/hauke/code/Beachlor/data/test_dataset/rgbd_dataset_freiburg3_walking_xyz"},
        {SubDataset::walking_halfsphere,"/home/hauke/code/Beachlor/data/test_dataset/rgbd_dataset_freiburg3_walking_halfsphere"},
        {SubDataset::walking_rpy,       "/home/hauke/code/Beachlor/data/test_dataset/rgbd_dataset_freiburg3_walking_rpy"},
        {SubDataset::walking_static,    "/home/hauke/code/Beachlor/data/test_dataset/rgbd_dataset_freiburg3_walking_static" }
    };
